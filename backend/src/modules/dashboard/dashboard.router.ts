...
import { statsQuerySchema, trendsQuerySchema, weeklyTrendsQuerySchema, rankingsQuerySchema } from './dashboard.schema';
...
router.get(
  '/weekly-trends',
  validate(weeklyTrendsQuerySchema, 'query'),
  asyncHandler(dashboardController.weeklyTrends)
);
router.get(
  '/rankings',
